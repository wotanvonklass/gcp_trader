#!/usr/bin/env python3
"""
Volume 5% Strategy Runner.

Independent process for NewsVolumeStrategy at 5% volume.
"""
...
# Use private Nautilus installation
...
def main():
    ...
    controller_config = ImportableControllerConfig(
        controller_path="strategies.volume_5pct.controller:Volume5PctController",
        config_path="strategies.volume_5pct.controller:Volume5PctControllerConfig",
        config={
            "project_id": project_id,
            "subscription_id": "benzinga-news-vol5",  # Dedicated subscription
    ...
    node_config = TradingNodeConfig(
        trader_id=TraderId("VOL5-TRADER"),
        ...
        logging=LoggingConfig(
            ...
            log_file_name=f"vol5_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
    ...
    logger.info("Volume 5% Strategy OPERATIONAL")
